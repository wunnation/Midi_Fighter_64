...
#define _MIDI_CLASS_DEVICE_H_
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Function Prototypes: */
			...
			bool MIDI_Device_ReceiveLargeEventPacket(USB_ClassInfo_MIDI_Device_t* const MIDIInterfaceInfo,
			                                    MIDI_EventPackets_t* const Event, uint8_t max_size) ATTR_NON_NULL_PTR_ARG(1) ATTR_NON_NULL_PTR_ARG(2);
